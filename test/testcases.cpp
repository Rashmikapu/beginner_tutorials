...
public:
  ...
  void SetUp() override {
     ...
     */
    bool ret_val = StartTalkerNode("beginner_tutorials", "minimal_publisher", "talker");
    ASSERT_TRUE(ret_val);
...
protected:
  ...
  bool StartTalkerNode(const char* pkg_name,
    ...
    return true;     // Return true if the node started successfully, false otherwise
  }
